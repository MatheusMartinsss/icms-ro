      ...
      <div className="max-w-6xl mx-auto px-6 py-6">
        <Tabs defaultValue="emitir-cte">
          ...
          <TabsContent value="mdfe">
            <div className="bg-white rounded-2xl p-6 shadow-sm border">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-medium">MDF-e</h2>
                <Link href="/mdfe">
                  <Button className="gap-2">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
              ...
              <p className="text-sm text-slate-500">Acesse a tela de MDF-e para emitir, encerrar e cancelar manifestos eletrônicos.</p>
            </div>
          </TabsContent>
